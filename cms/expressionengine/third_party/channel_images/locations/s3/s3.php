...
class CI_Location_s3 extends Image_Location
{
	...
	public function upload_file($source_file, $dest_filename, $dest_folder)
	{
		...
		$response = $this->S3->create_object($this->lsettings['bucket'], $subdir.$dest_folder.'/'.$dest_filename, array('fileUpload' => $source_file, 'contentType' => $filemime, 'acl' => $this->lsettings['acl'], 'storage' => $this->lsettings['storage']) );
